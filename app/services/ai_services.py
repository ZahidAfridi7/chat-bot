...
class AIService:
    ...
    def _generate_standard_response(self, message: str) -> str:
    ...
    def _generate_humorous_response(self, message: str) -> str:
    ...
    def _select_best_classic_response(self, candidates: List[str], context: dict) -> str:
